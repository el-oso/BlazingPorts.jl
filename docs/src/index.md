...
| **simdutf8** | `Utf8.isvalid_utf8` (ours) | **11× Base on multibyte** (18.6 vs 1.66), ASCII parity; **1.04× simdutf8 — beats the crate** (AVX2); byte-exact | ✅ **PORTED** (pure-Julia lemire SIMD) — found **StrictMode F33** |
